...
<body>
  <div class="container">
    <div class="card">
      <h2>Infectious Disease Analysis Requests</h2>
      <table>
        <tr>
          <th>ID</th>
          <th>User Name</th>
        ...
        <tr>
          ...
          <td>
            <% if ("Requested".equalsIgnoreCase(status)) { %>
              <a href="ta_Infectious_Disease_Analysis_Request1.jsp?usid=<%= id %>"><%= status %></a>
            <% } else if ("Permitted".equalsIgnoreCase(status)) { %>
              <%= status %>
            <% } %>
          </td>
        </tr>
