<title>Data Consumers Registration authen</title>
...
<%
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="o_DataOwnerRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
			...
			%>
			<p><a href="o_DataOwnerLogin.jsp">Back</a>         <a href="index.html">Home</a> </p>
