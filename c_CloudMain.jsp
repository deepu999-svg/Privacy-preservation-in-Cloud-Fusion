...
<body>
    ...
    <div class="menu_nav">
        <ul>
            <li><a href="c_CloudMain.jsp">Cloud Server Provider</a></li>
    ...
    <div class="content">
        <div class="mainbar">
            <div class="article">
                <h2>Welcome Cloud Service Provider (CSP):</h2>
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="c_View_All_Datasets.jsp">View All Stored Datasets</a></li>
                <li><a href="c_View_All_Datasets_By_Group_Location.jsp">View Datasets By Location Group</a></li>
                <li><a href="c_CloudLogin.jsp">Logout</a></li>
            </ul>
        </div>
    </div>
