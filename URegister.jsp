<title>Data Consumers Registration Authentication</title>
...
<%
					...
					if ( rs1.next() )
					   {
							...
							out.println("Data Consumers Name Already Exits");							
							%><p><a href="u_DataConsumersRegister.jsp">Back</a>         <a href="index.html">Home</a> </p><%
					   }
					   else
					   {
					...
					//		ps.setString(11,sk);		
							...
							if(x>0)
							{
									...
									%><p><a href="u_DataConsumersLogin.jsp">Back</a><a href="index.html">Home</a> </p><%
							}
						}
					} 
					catch (Exception e) 
