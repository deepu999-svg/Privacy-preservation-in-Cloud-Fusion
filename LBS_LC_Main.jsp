...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span class="style3">Privacy Preservation in Multi Cloud Secure Data Fusion for Infectious Disease Analysis</span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
		  <li class="active"><a href="LBS_LC__Main.jsp">LBS_LC</a></li>
          <li><a href="LBS_LC_Login.jsp">Logout</a></li>
        </ul>
      </div>
      <div class="clr"></div>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star">LBS LC Main</h2>
          <div class="clr"></div>
          <ul class="sb_menu style10">
            <li><a href="d_DomainMain.jsp">Home</a></li>
			<li><a href="LBS_LC_View_All_Datasets_By_Group_Location.jsp">Create and View All Datasets By Group Location</a></li>
