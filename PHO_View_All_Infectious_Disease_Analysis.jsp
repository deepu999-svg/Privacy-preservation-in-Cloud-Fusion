...
<head>
  <title>PHO_View_All_Infectious_Disease_Analysis</title>
...
<body>
  ...
  <div class="container">
    <div class="title">View All Infectious Disease Analysis</div>
    <iframe src="Result.jsp"></iframe>
    <a href="PHO_Main.jsp" class="back-btn"> Back</a>
  </div>
</body>
</html>
