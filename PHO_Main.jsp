...
<body>
    ...
    <div class="menu_nav">
        <ul>
            <li><a href="PHO_Main.jsp">PHO</a></li>
            <li><a href="PHO_Login.jsp">Logout</a></li>
        </ul>
    </div>
    ...
    <div class="content">
        ...
        <div class="sidebar">
            <h2 class="star">PHO Menu</h2>
            <ul>
                <li><a href="index.jsp">Home</a></li>
                <li><a href="PHO_View_All_Datasets_By_Aggregation_Group_Signatures.jsp">Analysis Datasets By Aggregation Group Signatures</a></li>
                <li><a href="PHO_View_All_Infectious_Disease_Analysis.jsp">View All Disease Analysis Results</a></li>
                <li><a href="PHO_View_All_Infectious_Disease_Location_Results.jsp">View Location Results</a></li>
