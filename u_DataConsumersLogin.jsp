...
<div class="container">
    ...
    <h2>Data Consumers Login</h2>

    <img src="images/Login.png" width="154" height="154" alt="Login Icon" />

    <form action="u_DataConsumersAuthentication.jsp" method="post">
    ...
    <div class="register-link">
        New user? click here to <a href="u_DataConsumersRegister.jsp">Register</a>
    </div>
</div>
